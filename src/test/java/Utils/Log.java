...
public class Log {
    ...
    //todo When the test starts, I should print the logs
    //todo When the test stops, I should print the log
    //todo If I want to print any message in between, I should print the log
