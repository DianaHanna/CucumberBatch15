...
public class CommonMethods extends PageInitializer {
    ...
    //todo =============================SCREENSHOT================================
    //todo This casts the webDriver instance "driver to TakeScreenshot interface
    public static byte[] takeScreenshot(String imageName){
        TakesScreenshot ts=(TakesScreenshot) driver;
        //todo This capture the screenshot and stores it as byte array
      byte[] picBytes  =ts.getScreenshotAs(OutputType.BYTES);
      //todo This captures the screenshot and stores it as a file in the source file variable
