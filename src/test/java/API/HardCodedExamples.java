...
public class HardCodedExamples {
    ...
    String token = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2ODUyMTMwMjIsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTY4NTI1NjIyMiwidXNlcklkIjoiNTI1NSJ9.n40ZzAplFQPFMYOj64Ox_Du2Am-5py6-YxznJ1BOd3E";
    ...
    public void acreateEmployee(){
        ...
        response.then().assertThat().
                body("Employee.emp_firstname", equalTo("diana"));
        response.then().assertThat().
                body("Employee.emp_lastname", equalTo("hanna"));
